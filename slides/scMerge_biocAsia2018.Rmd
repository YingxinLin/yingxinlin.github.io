...
We designed our package to be consistent with the popular BioConductor’s single cell analysis framework, namely the packages `SingleCellExperiment` and `scater`.
...
We now construct the PCA plot again on our normalised data. We can observe a much better separation by cell type as well as a better batch mixing.
...
If **all** cell type information is available to the users, or users have already performed clustering analysis using their favourite method, then it is possible to use this information to create pseudo-replicates. 
...
<a href="https://yingxinlin.github.io/slides/scMerge_biocAsia2018.html">
.black[`r icon::fa("file")` Slides: yingxinlin.github.io/slides/scMerge_biocAsia2018.html]
</a>
]
]